...
struct transfer {
  ...
  int index_tt_t0_reco;   /**< index for transfer type = recombination temperature (j=0 term) */
  int index_tt_t1_reco;   /**< index for transfer type = recombination temperature (j=1 term) */
  int index_tt_t2_reco;   /**< index for transfer type = recombination temperature (j=2 term) */
  int index_tt_t0_reio;   /**< index for transfer type = reionization temperature (j=0 term) */
  int index_tt_t1_reio;   /**< index for transfer type = reionization temperature (j=1 term) */
  int index_tt_t2_reio;   /**< index for transfer type = reionization temperature (j=2 term) */
  int index_tt_e;         /**< index for transfer type = E-polarization */
  int index_tt_e_reco;    /**< index for transfer type = recombination E-polarization */
  int index_tt_e_reio;    /**< index for transfer type = reionization E-polarization */
