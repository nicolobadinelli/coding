...
struct harmonic {
  ...
  /* rotated spectra from birefringence */
  int has_te_rot; /**< do we want rotated \f$ C_l^{TE}\f$? */
  int has_tb_rot; /**< do we want rotated \f$ C_l^{TB}\f$? */
  int has_ee_rot; /**< do we want rotated \f$ C_l^{EE}\f$? */
  int has_bb_rot; /**< do we want rotated \f$ C_l^{BB}\f$? */
  int has_eb_rot; /**< do we want rotated \f$ C_l^{EB}\f$? */
  ...
  /* rotated spectra indices */
  int index_ct_te_rot; /**< index for type rotated \f$ C_l^{TE} \f$ */
  int index_ct_tb_rot; /**< index for type rotated \f$ C_l^{TB} \f$ */
  int index_ct_ee_rot; /**< index for type rotated \f$ C_l^{EE} \f$ */
  int index_ct_bb_rot; /**< index for type rotated \f$ C_l^{BB} \f$ */
  int index_ct_eb_rot; /**< index for type rotated \f$ C_l^{EB} \f$ */
