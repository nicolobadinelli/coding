...
struct perturbations
{
  ...
  short has_cl_aa;                    /**< do we need \f$ C_l^{\alpha\alpha} \f$ ? */
  ...
  short has_source_delta_chi;
  short has_source_theta_chi;
  short has_source_alpha;  /* do we need birefringence alpha source? */
  ...
  int index_tp_t0_reco; /**< index value for recombination temperature (j=0 term) */
  int index_tp_t1_reco; /**< index value for recombination temperature (j=1 term) */
  int index_tp_t2_reco; /**< index value for recombination temperature (j=2 term) */
  int index_tp_t0_reio; /**< index value for reionization temperature (j=0 term) */
  int index_tp_t1_reio; /**< index value for reionization temperature (j=1 term) */
  int index_tp_t2_reio; /**< index value for reionization temperature (j=2 term) */
  int index_tp_e_reco;  /**< index value for recombination E-polarization source */
  int index_tp_e_reio;  /**< index value for reionization E-polarization source */
  int index_tp_p; /**< index value for polarization */
  int index_tp_p_reco; /**< index value for recombination polarization */
  int index_tp_p_reio; /**< index value for reionization polarization */
  ...
  int index_tp_delta_chi;
  int index_tp_alpha;      /* index for birefringence alpha source */
  int index_tp_alpha_reco;
  int index_tp_alpha_reio;
...
struct perturbations_vector
{
  ...
  int index_pt_delta_chi;   /**< anisotropic axion field */
  int index_pt_deltap_chi;  /**< anisotropic axion field velocity */
