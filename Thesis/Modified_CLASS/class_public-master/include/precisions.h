 ...
 */
class_string_parameter(sBBN_file,"/external/bbn/sBBN.dat","sBBN file")
...
/**
 * Trigger for switching chi perturbations to an effective-fluid approximation.
 * The switch is intended for rapidly oscillating (stiff) chi fields.
 * Recommended meaning in code: switch when (m_chi * a / H_conf) > chi_fluid_trigger.
 */
class_precision_parameter(chi_fluid_trigger,double,100.0)
/**
