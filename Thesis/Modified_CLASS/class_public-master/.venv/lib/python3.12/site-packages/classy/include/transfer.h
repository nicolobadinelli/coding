...
struct transfer {
  ...
  double tau_tomo_peak_reco; /**< conformal time of the actual recombination visibility peak used in the strict two-delta tomography */
  double tau_tomo_peak_reio; /**< conformal time of the actual reionization visibility peak used in the strict two-delta tomography */
  double tau_tomo_sigma_reco; /**< legacy field kept for source compatibility; unused in the strict two-delta tomography */
  double tau_tomo_sigma_reio; /**< legacy field kept for source compatibility; unused in the strict two-delta tomography */
