...
cdef extern from "class.h":
    ...
    cdef struct harmonic:
        ...
        int index_ct_ep
        int index_ct_aa
        int index_ct_aa_reco
        int index_ct_aa_reio
        int index_ct_at
        int index_ct_at_reco
        int index_ct_at_reio
        int index_ct_ae
        int index_ct_ae_reco
        int index_ct_ae_reio
        int index_ct_ee_reco
        int index_ct_ee_reio
        int index_ct_te_reco
        int index_ct_te_reio
        int index_ct_dd
        int index_ct_td
        int index_ct_pd
        int index_ct_ll
