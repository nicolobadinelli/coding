...
struct harmonic {
  ...
  int has_te_reco; /**< do we want split \f$ C_l^{TE} \f$ from recombination? */
  int has_te_reio; /**< do we want split \f$ C_l^{TE} \f$ from reionization? */
  /* legacy rotated-spectrum fields kept only for ABI/source compatibility */
  int has_te_rot; /**< legacy rotated \f$ C_l^{TE}\f$ flag (unused) */
  int has_tb_rot; /**< legacy rotated \f$ C_l^{TB}\f$ flag (unused) */
  int has_ee_rot; /**< legacy rotated \f$ C_l^{EE}\f$ flag (unused) */
  int has_bb_rot; /**< legacy rotated \f$ C_l^{BB}\f$ flag (unused) */
  int has_eb_rot; /**< legacy rotated \f$ C_l^{EB}\f$ flag (unused) */
  ...
  int index_ct_te_reco; /**< index for split \f$ C_l^{TE} \f$ from recombination */
  int index_ct_te_reio; /**< index for split \f$ C_l^{TE} \f$ from reionization */
  /* legacy rotated-spectrum indices kept only for ABI/source compatibility */
  int index_ct_te_rot; /**< legacy rotated \f$ C_l^{TE} \f$ index (unused) */
  int index_ct_tb_rot; /**< legacy rotated \f$ C_l^{TB} \f$ index (unused) */
  int index_ct_ee_rot; /**< legacy rotated \f$ C_l^{EE} \f$ index (unused) */
  int index_ct_bb_rot; /**< legacy rotated \f$ C_l^{BB} \f$ index (unused) */
  int index_ct_eb_rot; /**< legacy rotated \f$ C_l^{EB} \f$ index (unused) */
