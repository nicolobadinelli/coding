...
struct background
{
  ...
  int index_bi_chi0;          /**< axion field */
  int index_bi_chi0_prime;    /**< derivative of axion field */
  int index_bg_chi0;        /**< spectator field chi0 */
  int index_bg_chi0_prime;  /**< derivative of chi0 wrt conformal time */
  int index_bg_V_chi;       /**< spectator potential V(chi0) */
...
extern "C" {
  ...
  /** Spectator (chi) potential and its derivatives **/
  double V_chi(
              struct background *pba,
              double chi
              );
