...
int harmonic_indices(
  ...
  if (ppt->has_cls == _TRUE_) {
    ...
    /* types of C_l's relevant only for scalars: alpha-alpha, alpha-T, alpha-E, alpha-phi, phi-phi, T-phi, E-phi, d-d, T-d, a-d */

    if ((ppt->has_cl_cmb_polarization == _TRUE_) && (ppt->has_scalars == _TRUE_)) {
      phr->has_tb = _TRUE_;
    ...
    if ((ppt->has_cl_cmb_birefringence == _TRUE_) && (ppt->has_scalars == _TRUE_)) {
      phr->has_aa = _TRUE_;
    ...
    if ((ppt->has_cl_cmb_temperature == _TRUE_) && (ppt->has_cl_cmb_birefringence == _TRUE_) && (ppt->has_scalars == _TRUE_)) {
      phr->has_at = _TRUE_;
    ...
    if ((ppt->has_cl_cmb_polarization == _TRUE_) && (ppt->has_cl_cmb_birefringence == _TRUE_) && (ppt->has_scalars == _TRUE_)) {
      phr->has_ae = _TRUE_;
    ...
    if ((ppt->has_cl_cmb_birefringence == _TRUE_) && (ppt->has_cl_cmb_lensing_potential == _TRUE_) && (ppt->has_scalars == _TRUE_)) {
      phr->has_ap = _TRUE_;
      phr->index_ct_ap=index_ct;
      index_ct++;
    }
    else {
      phr->has_ap = _FALSE_;
    ...
    */
    ...
    if ((ppt->has_cl_cmb_birefringence == _TRUE_) && (ppt->has_cl_number_count == _TRUE_) && (ppt->has_scalars == _TRUE_)) {
      phr->has_ad = _TRUE_;
      phr->index_ct_ad=index_ct;
      index_ct+=phr->d_size;
    }
    else {
      phr->has_ad = _FALSE_;
    ...
    */
    ...
    if (ppt->has_scalars == _TRUE_) {
      ...
      if ((ppt->has_birefringence == _TRUE_) && (phr->has_bb == _TRUE_)) phr->l_max_ct[ppt->index_md_scalars][phr->index_ct_bb] = ppt->l_scalar_max;
      if (phr->has_te == _TRUE_) phr->l_max_ct[ppt->index_md_scalars][phr->index_ct_te] = ppt->l_scalar_max;
      if ((ppt->has_birefringence == _TRUE_) && (phr->has_tb == _TRUE_)) phr->l_max_ct[ppt->index_md_scalars][phr->index_ct_tb] = ppt->l_scalar_max;
      if ((ppt->has_birefringence == _TRUE_) && (phr->has_eb == _TRUE_)) phr->l_max_ct[ppt->index_md_scalars][phr->index_ct_eb] = ppt->l_scalar_max;
      ...
      if (phr->has_ap == _TRUE_) phr->l_max_ct[ppt->index_md_scalars][phr->index_ct_ap] = ppt->l_scalar_max;
      ...
      if (phr->has_ad == _TRUE_)
        for (index_ct=phr->index_ct_ad;
             index_ct<phr->index_ct_ad+phr->d_size;
             index_ct++)
          phr->l_max_ct[ppt->index_md_scalars][index_ct] = MIN(ppt->l_scalar_max,ppt->l_lss_max);
    ...
    if (ppt->has_tensors == _TRUE_) {
      ...
      if ((ppt->has_birefringence == _FALSE_) && (phr->has_bb == _TRUE_)) phr->l_max_ct[ppt->index_md_tensors][phr->index_ct_bb] = ppt->l_tensor_max;
    }
...
int harmonic_compute_cl(
  ...
  for (index_q=0; index_q < ptr->q_size; index_q++) {
    ...
    */
    ...
    if (phr->has_te == _TRUE_)
      ...
      if ((((_tensors_) && (ppt->has_birefringence == _FALSE_)) || 
           ((_scalars_) && (ppt->has_birefringence == _TRUE_))) && (phr->has_bb == _TRUE_)) {
      ...
      if ((_scalars_) && (ppt->has_birefringence == _TRUE_) && (ppt->has_tensors == _FALSE_) && (ppt->has_vectors == _FALSE_)) {

        if (phr->has_tb == _TRUE_) {
          cl_integrand[index_q*cl_integrand_num_columns+1+phr->index_ct_tb]=
          primordial_pk[index_ic1_ic2]
    ...
    if (_scalars_ && (phr->has_aa == _TRUE_))
      cl_integrand[index_q*cl_integrand_num_columns+1+phr->index_ct_aa]=
        primordial_pk[index_ic1_ic2]
        * transfer_ic1[ptr->index_tt_a]
        * transfer_ic2[ptr->index_tt_a]
        * factor;

    if (_scalars_ && (phr->has_at == _TRUE_))
      cl_integrand[index_q*cl_integrand_num_columns+1+phr->index_ct_at]=
        primordial_pk[index_ic1_ic2]
        * 0.5*(transfer_ic1[ptr->index_tt_a] * transfer_ic2_temp +
               transfer_ic1_temp * transfer_ic2[ptr->index_tt_a])
        * factor;

    if (_scalars_ && (phr->has_ae == _TRUE_))
      cl_integrand[index_q*cl_integrand_num_columns+1+phr->index_ct_ae]=
        primordial_pk[index_ic1_ic2]
        * 0.5*(transfer_ic1[ptr->index_tt_a] * transfer_ic2[ptr->index_tt_e]  +
               transfer_ic1[ptr->index_tt_e]  * transfer_ic2[ptr->index_tt_a])
        * factor;

    if (_scalars_ && (phr->has_ap == _TRUE_))
      cl_integrand[index_q*cl_integrand_num_columns+1+phr->index_ct_ap]=
        primordial_pk[index_ic1_ic2]
        * 0.5*(transfer_ic1[ptr->index_tt_a] * transfer_ic2[ptr->index_tt_lcmb]  +
               transfer_ic1[ptr->index_tt_lcmb]  * transfer_ic2[ptr->index_tt_a])
        * factor;
    ...
    if (_scalars_ && (phr->has_ad == _TRUE_)) {
      for (index_d1=0; index_d1<phr->d_size; index_d1++) {
        cl_integrand[index_q*cl_integrand_num_columns+1+phr->index_ct_ad+index_d1]=
          primordial_pk[index_ic1_ic2]
          * 0.5*(transfer_ic1[ptr->index_tt_a] * transfer_ic2_nc[index_d1] +
                 transfer_ic1_nc[index_d1] * transfer_ic2[ptr->index_tt_a])
          * factor;
      }
    }
  ...
  for (index_ct=0; index_ct<phr->ct_size; index_ct++) {
    ...
    if ((_tensors_ && (phr->has_tb == _TRUE_) && (index_ct == phr->index_ct_tb)) ||
        (_tensors_ && (phr->has_eb == _TRUE_) && (index_ct == phr->index_ct_eb)) || 
        ((ppt->has_birefringence == _FALSE_) && (phr->has_tb == _TRUE_) && (index_ct == phr->index_ct_tb)) || 
        ((ppt->has_birefringence == _FALSE_) && (phr->has_eb == _TRUE_) && (index_ct == phr->index_ct_eb)) ||
        (_scalars_ && (phr->has_bb == _TRUE_) && (ppt->has_birefringence == _FALSE_) && (index_ct == phr->index_ct_bb)) ||
        ...
        (_tensors_ && (phr->has_ap == _TRUE_) && (index_ct == phr->index_ct_ap)) ||
        ...
        (_tensors_ && (phr->has_ad == _TRUE_) && (index_ct == phr->index_ct_ad)) ||
