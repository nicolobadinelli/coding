...
int lensing_indices(
  ...
  if (phr->has_tb == _TRUE_) {
    ple->has_tb = _TRUE_;
    ple->index_lt_tb=phr->index_ct_tb;
  }
  else {
    ple->has_tb = _FALSE_;
  }
  ...
  if (phr->has_eb == _TRUE_) {
    ple->has_eb = _TRUE_;
    ple->index_lt_eb=phr->index_ct_eb;
  }
  else {
    ple->has_eb = _FALSE_;
  }
 ...
 if (phr->has_aa == _TRUE_) {
    ple->has_aa = _TRUE_;
    ple->index_lt_aa=phr->index_ct_aa;
  }
  else {
    ple->has_aa = _FALSE_;
  }
  ...
  if (phr->has_at == _TRUE_) {
    ple->has_at = _TRUE_;
    ple->index_lt_at=phr->index_ct_at;
  }
  else {
    ple->has_at = _FALSE_;
  }
  ...
  if (phr->has_ae == _TRUE_) {
    ple->has_ae = _TRUE_;
    ple->index_lt_ae=phr->index_ct_ae;
  }
  else {
    ple->has_ae = _FALSE_;
  }
  ...
  if (phr->has_ap == _TRUE_) {
    ple->has_ap = _TRUE_;
    ple->index_lt_ap=phr->index_ct_ap;
  }
  else {
    ple->has_ap = _FALSE_;
  }
