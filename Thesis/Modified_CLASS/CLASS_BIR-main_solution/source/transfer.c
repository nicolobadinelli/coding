...
int transfer_init(
  ...
  double tau_rec;
  /* conformal time at reionization */
  double tau_rei;
  ...
  */
  ...
  class_call(transfer_source_tau_size_max(ppr,pba,ppt,ptr,tau_rec,tau_rei,tau0,&tau_size_max),
             ptr->error_message,
             ptr->error_message);
...
int transfer_indices(
  ...
  if (ppt->has_scalars == _TRUE_) {
    ...
    class_define_index(ptr->index_tt_a,      ppt->has_cl_cmb_birefringence,    index_tt,1);
    ...
    if ((ppt->has_birefringence == _TRUE_) && (ppt->has_tensors == _FALSE_) && (ppt->has_vectors == _FALSE_)) {
  ...
  if (ppt->has_vectors == _TRUE_) {
    ...
    if ((ppt->has_birefringence == _FALSE_) && (ppt->has_scalars == _FALSE_) && (ppt->has_tensors == _FALSE_)) {
      class_define_index(ptr->index_tt_b, ppt->has_cl_cmb_polarization,index_tt,1);
    }
  ...
  if (ppt->has_tensors == _TRUE_) {
    ...
    if ((ppt->has_birefringence == _FALSE_) && (ppt->has_scalars == _FALSE_) && (ppt->has_vectors == _FALSE_)) {
    ...
    for (index_tt=0;index_tt<ptr->tt_size[index_md];index_tt++) {
      ...
      if (_scalars_) {
        ...
        if (ppt->has_birefringence == _TRUE_) {
          if ((ppt->has_cl_cmb_polarization == _TRUE_) && ((index_tt == ptr->index_tt_e) || (index_tt == ptr->index_tt_b))) {
           l_max=ppt->l_scalar_max;
          }
        }

        if (ppt->has_birefringence == _FALSE_) {
          if ((ppt->has_cl_cmb_polarization == _TRUE_) && (index_tt == ptr->index_tt_e)) {
           l_max=ppt->l_scalar_max;
          }
        }

        if ((ppt->has_cl_cmb_birefringence == _TRUE_) && (index_tt == ptr->index_tt_a))
          l_max=ppt->l_scalar_max;
    ...
    for (index_tt=0; index_tt<ptr->tt_size[index_md]; index_tt++) {
      ...
      if (_scalars_) {
        ...
        //  tp_of_tt[index_md][index_tt]=ppt->index_tp_p;
            tp_of_tt[index_md][index_tt]=ppt->index_tp_e;

        if ((ppt->has_birefringence == _TRUE_) && (ppt->has_cl_cmb_polarization == _TRUE_) && (index_tt == ptr->index_tt_b))          
            tp_of_tt[index_md][index_tt]=ppt->index_tp_b;

        if ((ppt->has_cl_cmb_birefringence == _TRUE_) && (index_tt == ptr->index_tt_a))
          tp_of_tt[index_md][index_tt]=ppt->index_tp_a;
      ...
      if (_vectors_) {
        ...
        if ((ppt->has_birefringence == _FALSE_) && (ppt->has_cl_cmb_polarization == _TRUE_) && (index_tt == ptr->index_tt_b))
        // tp_of_tt[index_md][index_tt]=ppt->index_tp_p;
           tp_of_tt[index_md][index_tt]=ppt->index_tp_b;
      }
 ...
 * @param tau_rei               Input: reionization time
...
int transfer_sources(
  ...
  if (_scalars_) {
    ...
    /* anisotropic cosmic birefringence */
    if ((ppt->has_cl_cmb_birefringence == _TRUE_) && (index_tt == ptr->index_tt_a) && (ppt->instant_emission == _TRUE_))
  ...
  if (redefine_source == _TRUE_) {
    ...
    if (_scalars_) {
      ...
      /* anisotropic birefringence: semi-instantaneous emission of photons at recombination */
      ...
      if ((ppt->has_cl_cmb_birefringence == _TRUE_) && (index_tt == ptr->index_tt_a))  {
       ...
       for (index_tau=0; index_tau < ppt->tau_size; index_tau++) {
        ...
        if ((tau >= tau_rec - 100) && (tau <= tau_rec + 100)) {
...
int transfer_can_be_neglected(
  ...
  *neglect = _FALSE_;
  ...
  if (_scalars_) {
    ...
    else if ((ppt->has_birefringence == _TRUE_) && (ppt->has_cl_cmb_polarization == _TRUE_) 
              && (index_tt == ptr->index_tt_b) && (l < (k-ppr->transfer_neglect_delta_k_S_e)*ra_rec)) *neglect = _TRUE_;

    else if ((ppt->has_cl_cmb_birefringence == _TRUE_) && (index_tt == ptr->index_tt_a) && (l < (k-ppr->transfer_neglect_delta_k_S_e)*ra_rec)) *neglect = _TRUE_;
    ...
    else if ((ppt->has_birefringence == _FALSE_) && (ppt->has_cl_cmb_polarization == _TRUE_) 
              && (index_tt == ptr->index_tt_b) && (l < (k-ppr->transfer_neglect_delta_k_V_b)*ra_rec)) *neglect = _TRUE_;
    ...
    if ((ppt->has_cl_cmb_temperature == _TRUE_) && (index_tt == ptr->index_tt_t2) && (l < (k-ppr->transfer_neglect_delta_k_T_t2)*ra_rec)) *neglect = _TRUE_;
              ...
              && (index_tt == ptr->index_tt_b) && (l < (k-ppr->transfer_neglect_delta_k_T_b)*ra_rec)) *neglect = _TRUE_;
  ...
  *neglect = _FALSE_;
  ...
  if (l > ppr->transfer_neglect_late_source*ptr->angular_rescaling) {
    ...
    if (_scalars_) {
      ...
      if (ppt->has_cl_cmb_polarization == _TRUE_) {
        if ((index_tt == ptr->index_tt_e) ||
            ((ppt->has_birefringence == _FALSE_) && (index_tt == ptr->index_tt_b)))
          *neglect = _TRUE_;
      }
    }
    else if (_tensors_) {
  ...
  *radial_type = SCALAR_TEMPERATURE_0;
  ...
  if (_scalars_) {
    ...
    if (ppt->has_cl_cmb_polarization == _TRUE_) {
      ...
      if ((ppt->has_birefringence == _TRUE_) && (index_tt == ptr->index_tt_b)) {
    ...
    if (ppt->has_cl_cmb_birefringence == _TRUE_) {
      ...
      if (index_tt == ptr->index_tt_a) {
        *radial_type = SCALAR_TEMPERATURE_0; /*Anisotropic Cosmic Birefringence has the same radial function */
      }
  ...
  if (_vectors_) {
    ...
    if (ppt->has_cl_cmb_polarization == _TRUE_) {
      ...
      if ((ppt->has_birefringence == _FALSE_) && (index_tt == ptr->index_tt_b)){
