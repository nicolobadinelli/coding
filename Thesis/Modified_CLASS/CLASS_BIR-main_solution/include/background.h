...
/** list of possible schemes for the AXF evolution */

enum evolution_scheme {NQF,PDE};
...
struct background
{
  ...
  double Omega0_axf;       /**< \f$ \Omega_{0 axf} \f$: axion field */
  ...
  enum evolution_scheme axion_evolution; /**< scheme for the axion field evolution */
  ...
  int axf_tuning_index;    /**< index in axf_parameters used for tuning */
  double phi_ini_scf;      /**< \f$ \phi(t_0) \f$: scalar field initial value */
  double phi_prime_ini_scf;/**< \f$ d\phi(t_0)/d\tau \f$: scalar field initial derivative wrt conformal time */
  int scf_parameters_size; /**< size of scf_parameters */
  double * axf_parameters; /**< list of parameters describing the axion field potential */
  double chi_ini_axf;      /**< \f$ \chi(t_0) \f$: axion field initial value */
  double chi_prime_ini_axf;/**< \f$ d\chi(t_0)/d\tau \f$: axion field initial derivative wrt conformal time */
  int axf_parameters_size; /**< size of axf_parameters */
  double axf_g;            /**< value of the cosmic birefringence axion-photon coupling constant */
  ...
  double chi0; /**< value of the axion field today in units of the reduced Planck mass */
  ...
  int index_bg_chi_axf;       /**< axion field value */
  int index_bg_chi_prime_axf; /**< axion field derivative wrt conformal time */
  int index_bg_V_axf;         /**< axion field potential V */
  int index_bg_dV_axf;        /**< axion field potential derivative V' */
  int index_bg_ddV_axf;       /**< axion field potential second derivative V'' */
  int index_bg_rho_axf;       /**< axion field energy density */
  int index_bg_p_axf;         /**< axion field pressure */
  int index_bg_p_prime_axf;   /**< axion field pressure */
  int index_bg_w_axf;         /**< axion field equation of state */
  int index_bg_beta_axf;      /**< isotropic cosmic birefringence angle */
  ...
  int index_bi_chi_axf;       /**< {B} axion field value */
  int index_bi_chi_prime_axf; /**< {B} axion field derivative wrt conformal time */
  ...
  short has_axf;       /**< presence of a axion field? */
...
extern "C" {
  ...
  /** Axion field potential and its derivatives **/
  double V_axf(
               struct background *pba,
               double chi
               );
