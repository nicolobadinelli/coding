...
struct harmonic {
  ...
  int has_tb; /**< do we want \f$ C_l^{TB}\f$? */
  int has_eb; /**< do we want \f$ C_l^{EB}\f$? */
  ...
  int has_ad; /**< do we want \f$ C_l^{\alpha d}\f$? */
  ...
  int index_ct_tb; /**< index for type \f$ C_l^{Tb} \f$*/
  ...
  int index_ct_ap; /**< index for type \f$ C_l^{\alpha\phi} \f$*/
  ...
  int index_ct_ad; /**< first index for type \f$ C_l^{ad} \f$(d_size values) */
