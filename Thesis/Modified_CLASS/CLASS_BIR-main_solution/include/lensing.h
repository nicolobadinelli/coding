...
struct lensing {
  ...
  int has_tb; /**< do we want lensed \f$ C_l^{TB}\f$? */
  int has_eb; /**< do we want lensed \f$ C_l^{EB}\f$? */
  int has_aa; /**< do we want \f$ C_l^{\alpha\alpha}\f$? (\f$ \alpha \f$ = anisotropic birefringence) */
  int has_at; /**< do we want \f$ C_l^{\alpha T}\f$? */
  int has_ae; /**< do we want \f$ C_l^{\alpha E}\f$? */
  int has_ap; /**< do we want \f$ C_l^{\alpha\phi}\f$? */
  ...
  int index_lt_aa; /**< index for type \f$ C_l^{\alpha\alpha} \f$*/
  int index_lt_at; /**< index for type \f$ C_l^{\alpha T} \f$*/
  int index_lt_ae; /**< index for type \f$ C_l^{\alpha E} \f$*/
  int index_lt_ap; /**< index for type \f$ C_l^{\alpha\phi} \f$*/
