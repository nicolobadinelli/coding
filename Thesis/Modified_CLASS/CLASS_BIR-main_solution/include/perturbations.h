...
struct perturbations
{
  ...
  short has_birefringence; /**< do we need to include birefringence effects ? */
  ...
  short has_cl_cmb_birefringence;     /**< do we need \f$ C_l \f$'s for anisotropic birefringence? */
  short instant_emission;              /**< do we compute \f$ C_l \f$'s for birefringence in the instantaneous emission approximation? */ 
  ...
  short has_source_a;          /**< do we need source for anisotropic birefringence? */
  ...
  short has_source_delta_chi_axf;  /**< do we need source for axion field's fluctuation? */
...
//int index_tp_p; /**< index value for polarization */
  ...
  int index_tp_a; /**< index value for anisotropic birefringence */
  ...
  int index_tp_delta_chi_axf;  /**< index value for axion field's fluctuation */
...
struct perturbations_vector
{
  ...
  int index_pt_chi_axf;  /**< axion field density */
  int index_pt_chi_prime_axf;  /**< axion field velocity */
