...
cdef class Class:
    ...
    def raw_cl(self, lmax=-1, nofail=False):
        ...
        has_flags = [
            ...
            (self.hr.has_tb, self.hr.index_ct_tb, 'tb'),
            ...
            (self.hr.has_ap, self.hr.index_ct_ap, 'ap'),
    ...
    def lensed_cl(self, lmax=-1,nofail=False):
        ...
        has_flags = [
            ...
            (self.le.has_aa, self.le.index_lt_aa, 'aa'),
            (self.le.has_at, self.le.index_lt_at, 'at'),
            (self.le.has_ae, self.le.index_lt_ae, 'ae'),
            (self.le.has_ap, self.le.index_lt_ap, 'ap'),
    ...
    def density_cl(self, lmax=-1, nofail=False):
        ...
        has_flags = [
            ...
            (self.hr.has_ad, self.hr.index_ct_ad, 'ad'),
        ...
        for ell from 2<=ell<lmax+1:
            ...
            if 'ad' in spectra:
                cl['ad'][ell] = dcl[self.hr.index_ct_ad]
        cl['ell'] = np.arange(lmax+1)
...
#                raise CosmoSevereError(self.fo.error_message)
    ...
    def get_sources(self):
        ...
        #    names.append("p")
        if self.pt.has_source_p:
            indices.append(self.pt.index_tp_e)
            names.append("e")
        if self.pt.has_source_p:
            indices.append(self.pt.index_tp_b)
            names.append("b")
